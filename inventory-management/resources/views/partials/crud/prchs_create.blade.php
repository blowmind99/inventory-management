        ...
        <div class="content">
            ...
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Add Data Purchase</h3>
                </div>
                <div class="block-content">
                    <form action="{{ url('/dashboard/purchase/add') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-control" name="inventori_id" id="selectPrice">
                                        <option disabled selected class="text-muted">Choose Item...</option>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" class="form-control" id="example-text-input" name="price" value=""required id="price">
                                </div>
                                <div class="mb-4">

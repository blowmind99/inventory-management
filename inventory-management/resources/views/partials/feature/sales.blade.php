    ...
    <main id="main-container">
        <div class="content">
            ...
            <div class="block block-rounded bg-gd-dusk">
                <div class="block-content bg-white-5">
                    <div class="py-4 text-center">
                        <h1 class="h2 fw-bold text-white mb-2">Sales</h1>
            ...
            <div class="mb-4 d-flex justify-content-end">
                <a class="btn btn-lg btn-success" href="{{ url('/dashboard/sales/create') }}">Add Data</a>
            </div>
            @if(session('message'))
                        ...
                        <table class="table table-borderless table-hover table-striped table-vcenter mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-alt-secondary" href="{{ url('/dashboard/sales/edit/'.encrypt($item->id)) }}">
                                    ...
                                    <div class="modal fade" id="modal-fadein{{ $item->id }}" tabindex="-1" aria-labelledby="modal-fadein" style="display: none;" aria-modal="true" role="dialog">
                                        <div class="modal-dialog" role="document" >
                                            <div class="modal-content">
                                                <form action="{{ url('/dashboard/sales/delete/'.$item->id) }}" enctype="multipart/form-data" method="post">
                                                    @csrf
                                    ...
                                    <div class="modal fade" id="modal-fadeinshow{{ $item->id }}" tabindex="-1" aria-labelledby="modal-fadein" style="display: none;" aria-modal="true" role="dialog">
                                        <div class="modal-dialog" role="document" >
                                            ...
                                            <div class="block block-rounded shadow-none mb-0">
                                                ...
                                                @php
                                                    $data = App\Models\Sales::find($item->id)->first();
                                                    $details = App\Models\SalesDetail::where('sales_id', $item->id)->first();
                                                @endphp
                                                <div class="block-content fs-sm">
                                                    <div class="row">
                                                        <div class="col-lg-12">
